...
type WorkloadInterface interface {
	...
	Apply(ctx context.Context, workload *astrocorev1.WorkloadApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Workload, err error)
	ApplyStatus(ctx context.Context, workload *astrocorev1.WorkloadApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Workload, err error)
	WorkloadExpansion
}
...
func (c *workloads) Apply(ctx context.Context, workload *astrocorev1.WorkloadApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Workload, err error) {
	if workload == nil {
...
func (c *workloads) ApplyStatus(ctx context.Context, workload *astrocorev1.WorkloadApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Workload, err error) {
	if workload == nil {
		return nil, fmt.Errorf("workload provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
