...
type ClusterInterface interface {
	...
	Apply(ctx context.Context, cluster *corev1.ClusterApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Cluster, err error)
	ApplyStatus(ctx context.Context, cluster *corev1.ClusterApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Cluster, err error)
	ClusterExpansion
}
...
func newClusters(c *AstroV1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *clusters) Apply(ctx context.Context, cluster *corev1.ClusterApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Cluster, err error) {
	if cluster == nil {
...
func (c *clusters) ApplyStatus(ctx context.Context, cluster *corev1.ClusterApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Cluster, err error) {
	if cluster == nil {
		return nil, fmt.Errorf("cluster provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
