...
type ClusterStatusApplyConfiguration struct {
	...
	Phase                     *astrocorev1.ClusterPhase                     `json:"phase,omitempty"`
...
func (b *ClusterStatusApplyConfiguration) WithPhase(value astrocorev1.ClusterPhase) *ClusterStatusApplyConfiguration {
	b.Phase = &value
	return b
}
...
func (b *ClusterStatusApplyConfiguration) WithAllocatable(value corev1.ResourceList) *ClusterStatusApplyConfiguration {
	b.Allocatable = &value
	return b
}
...
func (b *ClusterStatusApplyConfiguration) WithUsage(value corev1.ResourceList) *ClusterStatusApplyConfiguration {
	b.Usage = &value
	return b
}
...
func (b *ClusterStatusApplyConfiguration) WithSubClusterAllocatable(value corev1.ResourceList) *ClusterStatusApplyConfiguration {
...
func (b *ClusterStatusApplyConfiguration) WithSubClusterUsage(value corev1.ResourceList) *ClusterStatusApplyConfiguration {
