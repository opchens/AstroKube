...
type WorkloadApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *astrocorev1.WorkloadSpec   `json:"spec,omitempty"`
	Status                           *astrocorev1.WorkloadStatus `json:"status,omitempty"`
}
...
func (b *WorkloadApplyConfiguration) WithSpec(value astrocorev1.WorkloadSpec) *WorkloadApplyConfiguration {
	b.Spec = &value
	return b
}
...
func (b *WorkloadApplyConfiguration) WithStatus(value astrocorev1.WorkloadStatus) *WorkloadApplyConfiguration {
	b.Status = &value
	return b
}
