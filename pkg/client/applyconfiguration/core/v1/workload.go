...
type WorkloadApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *corev1.WorkloadSpec   `json:"spec,omitempty"`
	Status                           *corev1.WorkloadStatus `json:"status,omitempty"`
}
...
func (b *WorkloadApplyConfiguration) WithSpec(value corev1.WorkloadSpec) *WorkloadApplyConfiguration {
	b.Spec = &value
	return b
}
...
func (b *WorkloadApplyConfiguration) WithStatus(value corev1.WorkloadStatus) *WorkloadApplyConfiguration {
	b.Status = &value
	return b
}
