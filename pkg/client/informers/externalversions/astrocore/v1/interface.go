...
type Interface interface {
	...
	// ClusterLists returns a ClusterListInformer.
	ClusterLists() ClusterListInformer
...
// ClusterLists returns a ClusterListInformer.
func (v *version) ClusterLists() ClusterListInformer {
	return &clusterListInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
